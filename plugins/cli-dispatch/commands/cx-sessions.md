...
!`bash "${CLAUDE_PLUGIN_ROOT}/scripts/cli-dispatch-sessions.sh" codex`

The Codex session listing above already ran — do NOT run it again. Present it
as-is, newest first; this filtered view has no backend column.
