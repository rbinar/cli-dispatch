...
use oc-worktree-run.sh — run oc-agent --cwd <repo> directly, even for a repo-changing
...
oc-worktree-run.sh errors, retry AT MOST once with a new branch name, then report the
