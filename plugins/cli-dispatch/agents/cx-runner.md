...
use cx-worktree-run.sh — run cx-agent --cwd <repo> directly, even for a repo-changing
...
cx-worktree-run.sh errors, retry AT MOST once with a new branch name, then report the
