#!/usr/bin/env bash
# Full health check for every cli-dispatch backend: CLIs on PATH, keys, auth.
#
...
# probe below must read the argument, not the env var.
#
