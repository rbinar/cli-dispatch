...
const parserScript = path.resolve('plugins/cli-dispatch/scripts/ds-stream-parse.mjs')
const testDir = path.resolve('plugins/cli-dispatch/scripts/__tests__/tmp-test-ds-session')
